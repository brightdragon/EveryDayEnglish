...
(ctx: Context) : ContextWrapper(ctx) {
    ...
    init {
        val chan1 = NotificationChannel(PRIMARY_CHANNEL, "Park", NotificationManager.IMPORTANCE_DEFAULT)
        chan1.lightColor = Color.GREEN
        chan1.lockscreenVisibility = Notification.VISIBILITY_PRIVATE
        manager.createNotificationChannel(chan1)

        val chan2 = NotificationChannel(SECONDARY_CHANNEL, "Kwang", NotificationManager.IMPORTANCE_HIGH)
    ...
    fun getNotification1(title: String, body: String): Notification.Builder {
        ...
        val penddingIntent: PendingIntent = PendingIntent.getActivity(mContext, 0, Intent(mContext, EvEngMainActivity::class.java), 0)
    ...
    private val smallIcon: Int
        get() = R.mipmap.everyenglish_icon
